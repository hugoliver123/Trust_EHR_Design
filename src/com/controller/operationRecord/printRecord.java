...
public class printRecord extends HttpServlet {
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AuditLog auditLog = new AuditLog(formattedDate,user.getUserId(), req.getRemoteAddr(), "PRINT",  fileName,
                patientId, userPatient.getUserName());
        Block block = new Block(auditLog, 110, "police"); //权威者签名，提交
        //auditlog audit_log = new auditlog(formattedDate, user.getUserId(), req.getRemoteAddr(),"PRINT", fileName);
